...
public final class ExerciseDao_Impl implements ExerciseDao {
  ...
  public ExerciseDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfExerciseEntity = new EntityInsertionAdapter<ExerciseEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `exercises` (`id`,`name`,`category`,`instructions`,`youtubeUrl`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(5, entity.getYoutubeUrl());
      }
    };
  }
  ...
  public Flow<List<ExerciseEntity>> getAllExercises() {
    final String _sql = "SELECT * FROM exercises ORDER BY category, name";
      ...
      public List<ExerciseEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new ExerciseEntity(_tmpId,_tmpName,_tmpCategory,_tmpInstructions,_tmpYoutubeUrl);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<ExerciseEntity>> getExercisesByCategory(final String category) {
    final String _sql = "SELECT * FROM exercises WHERE category = ? ORDER BY name";
  ...
  @Override
  public Object getExerciseById(final int id,
      ...
      public ExerciseEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpYoutubeUrl;
            _tmpYoutubeUrl = _cursor.getString(_cursorIndexOfYoutubeUrl);
            _result = new ExerciseEntity(_tmpId,_tmpName,_tmpCategory,_tmpInstructions,_tmpYoutubeUrl);
          } else {
            _result = null;
          }
          return _result;
